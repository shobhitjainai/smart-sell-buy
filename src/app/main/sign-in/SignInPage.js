...
function SignInPage() {
  ...
  return (
    ...
    <div className="flex justify-center h-screen items-center w-full">
      <Paper className="flex justify-center w-1/3 items-center">
        <div className="flex flex-col justify-center items-center p-35 w-3/4 mx-auto sm:mx-0  ">
          ...
          >
            ...
            <Typography className="mb-32 mx-auto mt-8 text-xl tracking-tight leading-tight">
  Do not have an account?{' '}
  <br/>
  <Link className="cursor-pointer pl-20 hover:text-blue-500 hover:underline color-black" to="/sign-up">
    CREATE ACCOUNT
  </Link>
</Typography>
