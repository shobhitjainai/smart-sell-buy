...
function SignUpPage() {
  ...
  return (
    ...
    <div className="flex justify-center items-center w-full h-1/2">
      <Paper className="flex justify-center items-center w-1/2">
        <div className="flex flex-col justify-center items-center p-32  mx-auto sm:mx-0 w-1/2 ">
          {/* <img className=" h-64" src="assets/images/logo/smartB&S_logo.webp" alt="logo" /> */}
          <div className='text-3xl text-red-500 font-bold h-36'>Smart Buy & Sales</div>

          <Typography className="mt-12 text-2xl tracking-tight leading-tight">
...
<div className="flex justify-center items-center mt-2 font-medium">
